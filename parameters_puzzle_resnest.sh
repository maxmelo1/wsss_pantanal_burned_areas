...
#    --experiment_name ResNest101@Puzzle@CLF@3@train@scale=0.5,1.0,1.5,2.0 \
#    --domain train \
...
#
python3 evaluate.py \
    --experiment_name ResNest101@Puzzle@CLF@3@train@scale=0.5,1.0,1.5,2.0@crf=0\
    --mode png \
    --gt_dir /mnt/58B0FAA2B0FA85B2/max/datasets/pantanal/queimadas/dataset2_bkp/SegmentationClass/ \
